...
class AnnotationCleaner:
    ...
    def step_padding(self):
        self.logger.info("[STEP 1] Image Padding")
    ...
    def step_annotation_clean(self):
        self.logger.info("[STEP 2] Annotation Cleaning")
    ...
    def step_restore_crop(self):
        self.logger.info("[STEP 3] Restore Cropped Images")
    ...
    def step_merge_and_cleanup(self):
        self.logger.info("[STEP 4] Merge Results & Cleanup")
